      ...
      <form onSubmit={onSubmit} className="card-surface w-full rounded-2xl p-6 md:p-8">
        ...
        <div className="mt-5 grid gap-3">
          ...
          <div className="relative">
            <input required type={showPw ? "text" : "password"} placeholder="Password" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} className="w-full rounded-xl border border-white/20 bg-[#102032] px-4 py-3 pr-11 outline-none focus:border-ember" />
